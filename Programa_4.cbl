      *-----------------------------------------------------------------------*
       IDENTIFICATION DIVISION.
              PROGRAM-ID. Equacao_2_Grau_Estruturado.
      *-----------------------------------------------------------------------*
      ...
      *--------------------------------------------------------------------*
       ...
       01-Main.
         ...
         PERFORM 02-Receber_Variaveis.
         PERFORM 03-Calcular_Delta.
         PERFORM 04-Validar.
         PERFORM 05-MenorZero.
         PERFORM 06-IgualZero.
         PERFORM 07-MaiorZero.
         PERFORM 08-A0.
         PERFORM 09-Continue.
         PERFORM 10-Finalizar.
