      ...
      * Declaração de variáveis: Nota 1 e Nota 2, soma, subtracao, multiplicacao e divisão
           02 W-N1 PIC 9(03) COMP VALUE ZEROS.
           02 W-N2 PIC 9(03) comp VALUE ZEROS.
      ...
      * EXIBE MENSAGEM NA TELA, intereção com o usuário
       01 MENSAGEMS-DE-TELA.
           ...
           02 MENSA8 PIC x(40) VALUE "Opcao invalida, favor redigitar".
           02 MENSA9 PIC x(50) VALUE "Continua? (S/N):".
       ...
       01-Inicio.
           ...
           MOVE ZEROS TO DADOS.
           PERFORM 02-Entrada THRU 05-Rot-Continua.
      ...
      * Exibir a Divisão das variáveis.
           ...
           if W-N2 = 0 THEN
               display "Incapaz de dividir por 0" at 1221
           ELSE
      ...
      *    ao lado, foi necessário multiplicar por 10 para andar uma casa para dar o valor real.
       ...
       05-Rot-Continua.
           ...
           display MENSA9 at 1401.
           accept WS-Cont AT 1419.
           if WS-Cont = 'S' or 's' perform 01-Inicio
           else if WS-Cont = 'N' or 'n' display MENSA7 at 1524 perform
           06-Finaliza
           else display MENSA8 at 1524
